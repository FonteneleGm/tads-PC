...
under_the_average = (90 * average_beat)//100
over_the_average = (110 * average_beat)//100
#A saída deve conter dois valores inteiros:
count = 0
for beat in beats:
    #if beat > average_beat * 1.1 or beat < average_beat * 0.9: Dessa maneira da erro no Teste 3 (casos específicos).
    if beat > over_the_average or beat < under_the_average:
