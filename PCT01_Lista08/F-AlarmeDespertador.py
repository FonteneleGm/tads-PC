...
#Por isso, carrega seu relógio digital despertador para todos os lugares, e sempre que tem um tempo de descanso procura dormir, programando o alarme despertador 
#para a hora em que tem que acordar. No entanto, com tanta ansiedade para dormir, acaba tendo dificuldades para adormecer e aproveitar o descanso.
...
#Mas ela realmente não é muito boa com números, e pediu sua ajuda para escrever um programa que, dada a hora corrente e a hora do alarme, 
#determine o número de minutos que ela poderia dormir.


#A entrada contém vários casos de teste. Cada caso de teste é descrito em uma linha, contendo quatro números inteiros 
#H1 , M1 , H2 e M2, com H1: M1 representando a hora e minuto atuais, e H2: M2 representando a hora e minuto para os quais o alarme despertador foi programado (0 ≤ H1 ≤ 23, 0 ≤ M1 ≤ 59, 0 ≤ H2 ≤ 23, 0 ≤ M2 ≤ 59).

#O final da entrada é indicado por uma linha que contém apenas quatro zeros, separados por espaços em branco. 
#É garantido que a entrada não possui mais do que 106 casos de teste.
...
while True:
    total_time0 = (h1*60) + m1
    total_time1 = (h2*60) + m2
    if total_time1 - total_time0 < 0:
        total_time1 = total_time1 + 1440
    print(total_time1 - total_time0)
    h1, m1, h2, m2 = map(int, input().split())
